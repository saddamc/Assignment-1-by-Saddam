  ...
  try {
    ...
    app.post('/payments', async(req, res) => {
      ...
      mg.messages.create(process.env.MAIL_SENDING_DOMAIN, {
        from: "Excited User <mailgun@sandbox0fd6ce76bc5745cc9279d14a2916fd3b.mailgun.org>",
        to: ["nirobvhai1@gmail.com"],
     ...
     * 3. for every item in the menu collection that you found form a payment entry (document)
     */
